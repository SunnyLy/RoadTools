...
public class RequestManager {
    ...
    private static final int MEM_CACHE_SIZE = 1024 * 1024 * ((ActivityManager) RoadToolsApplication.getContext()
    ...
    private static Cache openCache() {
        return new DiskBasedCache(CacheUtils.getExternalCacheDir(RoadToolsApplication.getContext()),
                10 * 1024 * 1024);
    }
                    ...
                    if (!isImmediate && defaultImageDrawable != null) {
                        TransitionDrawable transitionDrawable = new TransitionDrawable(
                                new Drawable[] {
                                        ...
                                        new BitmapDrawable(RoadToolsApplication.getContext().getResources(),
                                                response.getBitmap())
                                });
