package com.changshagaosu.roadtools.ui.view.tree;
...
public abstract class TreeBaseAdapter<T> extends BaseAdapter {
     ...
     *
     * @param id         树节点id
     * @param isSelected true为选中，false为不选中
     */
