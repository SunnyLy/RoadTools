...
import com.changshagaosu.roadtools.bean.C_Company;

import java.util.List;

public class C_CompanyAdapter extends BaseAdapter {
	private List<C_Company> mList;
	private Context mContext;

	public C_CompanyAdapter(Context pContext, List<C_Company> pList) {
